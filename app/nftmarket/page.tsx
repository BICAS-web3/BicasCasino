...
import {
  ...
  MODEL_3,
  MODEL_4,
} from "@/src/shared/nftContractAddress/index";
...
export default function Nftmarket() {
  ...
  return (
    <>
      <div className="
        py-[20px] flex flex-wrap content-start justify-center max-h-[calc(100vh_-_80px)]
        overflow-y-scroll w-fit flex-[1_1_auto] gap-[13px]
      ">
