                ...
                <div className='p-[20px]'>
                    <div className="text-center flex items-center justify-between gap-[10px]">
                        <div className='flex flex-col gap-[5px] text-center items-center'>
                            <span className="text-[#7e7e7e] text-[13px] sm:text-[17px] font-medium">Hist</span>
                            <span className="text-[#fff] text-[13px] sm:text-[17px] font-medium">0</span>
                        </div>
                        <div className='flex flex-col gap-[5px] text-center items-center'>
                            <span className="text-[#7e7e7e] text-[13px] sm:text-[17px] font-medium">Commission Rate</span>
                            <span className="text-[#fff] text-[13px] sm:text-[17px] font-medium">25% (Level 1)</span>
                        </div>
                        <div className='flex flex-col gap-[5px] text-center items-center'>
                            <span className="text-[#7e7e7e] text-[13px] sm:text-[17px] font-medium">Referalls</span>
                            <span className="text-[#fff] text-[13px] sm:text-[17px] font-medium">0</span>
                        </div>
                    </div>
                    <div className="text-center mt-[30px] flex items-center justify-between gap-[10px]">
                        <div className='flex flex-col gap-[5px] text-center items-center'>
                            <span className="text-[#7e7e7e] text-[13px] sm:text-[17px] font-medium">Total Commission</span>
                            <span className="text-[#fff] text-[13px] sm:text-[17px] font-medium">0.000 DC</span>
                        </div>
                        <div className='flex flex-col gap-[5px] text-center items-center'>
                            <span className="text-[#7e7e7e] text-[13px] sm:text-[17px] font-medium">Available</span>
                            <span className="text-[#fff] text-[13px] sm:text-[17px] font-medium">0.000 DC</span>
                        </div>
                        <div className='flex flex-col gap-[5px] text-center items-center'>
                            <span className="text-[#7e7e7e] text-[13px] sm:text-[17px] font-medium">Transfered</span>
                            <span className="text-[#fff] text-[13px] sm:text-[17px] font-medium">0.000 DC</span>
                        </div>
                    </div>
                    <Accordion type="single" collapsible className="w-full gap-[15px] flex flex-col mt-[30px]">
                        {
                            accItems.map((item, ind) => (
                                <AccordionItem key={ind} value={item.title}>
                                    <AccordionTrigger className='rounded-[5px] w-full h-full bg-[#212121] p-[15px_10px] text-[14px] font-medium' >
                                        <div className='flex items-center justify-between w-full mr-[10px] sm:mr-[15px]'>
                                            ...
                                            <div className='flex gap-[10px] items-center'>
                                                <span className="text-[14px] font-medium">Total <span className='hidden sm:inline'>Commission</span>:</span>
                                    ...
                                    <AccordionContent className='bg-[#1A1A1A] p-[15px_10px]' >
                                        <Swiper slidesPerView={'auto'} spaceBetween={20} modules={[Scrollbar]} 
                                            scrollbar={{
                                                el: ".scroll-bar",
                                                draggable: true,
                                              }}
                                        className='affiliates_swiper' breakpoints={{
                                            650: {
                                                slidesPerView: 4,
                                                spaceBetween: 0
                                            }
                                        }} >
                                            {
                                                    item.list.map((item1, ind1) => (
                                                        <SwiperSlide className={`affiliates_swiper_slide affiliates_swiper_slide${ind1}`}>
                    ...
                    <p className='pt-[10px] text-[#7e7e7e] text-[14px] font-normal'>(Wager can only come from users who have purchased or set up email)</p>
                </div>
                
            </div>
            <div className='flex items-center justify-end p-[20px] border-t-[1px] border-[#3E3E3E]'> 
                <SubmitBtn className='max-w-full' title='Create New Campaign' handler={createHandler} />
            </div>
        </div>
    )
}