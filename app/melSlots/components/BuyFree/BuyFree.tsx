...
export const BuyFree:FC<BuyFreeProps> = () => {
    ...
    return (
        <div className={`w-full p-[20px] h-full flex justify-center items-center absolute top-0 left-0 transition-all duration-300 bg-[rgba(0,_0,_0,_0.6)] z-[22] ${modalVisibility ? 'opacity-1 visible' : 'opacity-0 invisible'}`}>
            <div className='w-full relative flex flex-col items-center p-[30px] max-w-[435px] sm:h-full bg-[#000] max-h-[280px]'>
                <Border className='w-full h-full absolute top-0 left-0' />
                <span className='buy-text uppercase text-center text-[18px] sm:text-[28px] font-medium'>купить <br/> бесплатные спины</span>
                <span className='buy-qt-text flex items-end text-[25px] sm:text-[44px] font-extrabold leading-[60px] gap-[15px]'>20,00 <span className='uppercase text-[22px] sm:text-[36px] leading-[60px] sm:leading-[53px]'>dc</span></span>
