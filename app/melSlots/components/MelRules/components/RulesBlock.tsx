...
export const RulesBlock:FC<RulesBlockProps> = () => {
    return (
        <div className='flex flex-col items-center'>
            <h1 className='text-center text-[26px] font-bold block mb-[8px] uppercase w-full'>правила игры</h1>
            <p className="text-[16px] font-bold max-w-[800px] text-center">
            ...
            <div className='flex gap-[5vw] mt-[20px]'>
                {
            ...
            <div className='flex items-center justify-center gap-[16px] mt-[20px]'>
                <div className='flex flex-col items-end justify-center'>
                    <span className='text-[17px] font-semibold'>6 - $200,00</span>
                    <span className='text-[17px] font-semibold'>5 - $10,00</span>
                    <span className='text-[17px] font-semibold'>4 - $6,00</span>
                </div>
                <img src='/images/mell/melGif.gif' className='w-[125px] h-[125px]' />
                <div className='flex flex-col items-start justify-center max-w-[380px]'>
                    <span className='text-[19px] font-semibold'>Этот символ - MELLSPIN</span>
                    <span className='text-[19px] font-semibold'>Символ MELLSPIN присутствует на всех барабанах.</span>
                    <span className='text-[19px] font-semibold'>MELLSPIN платит в любой позиции.</span>
                </div>
            </div>
        </div>
    )
