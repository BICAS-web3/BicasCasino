...
export const Fall:FC<FallProps> = () => {
    return (
        <div className='flex flex-col items-center'>
            <h1 className='text-center text-[12px] sm:text-[26px] font-bold block mb-[8px] uppercase w-full'>функция “падение”</h1>
            <p className="text-[10px] sm:text-[16px] uppercase font-bold max-w-[800px] mb-[8px] text-center">
            ...
            <p className="text-[10px] sm:text-[16px] uppercase block mb-[8px] font-bold max-w-[800px] text-center">
            ...
            <p className="text-[10px] sm:text-[16px] uppercase font-bold max-w-[800px] text-center">
            ...
            <div className='flex items-center gap-[10px] sm:gap-[5vw] mt-[45px] mb-[45px]'>
                <img src={en1.src} className='w-full h-[50px] sm:h-[100px]' alt='en' />
                <img src={en2.src} className='w-full h-[50px] sm:h-[100px]' alt='en' />
                <img src={en3.src} className='w-full h-[50px] sm:h-[100px]' alt='en' />
                <img src={en4.src} className='w-full h-[50px] sm:h-[100px]' alt='en' />
                <img src={en5.src} className='w-full h-[50px] sm:h-[100px]' alt='en' />
            </div>
            <p className='text-[10px] sm:text-[16px] text-center max-w-[850px] font-semibold leading-[22px]'>
