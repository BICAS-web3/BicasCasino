    ...
    return (
        <div className="flex gap-[15px] items-center">
            ...
            <div className='relative top-[-30px] cursor-pointer flex w-[120px] h-[120px] items-center justify-center'>
                ...
                <Border className='w-full h-full absolute top-0 left-0' />
                <div className='absolute bottom-[-10px] w-[110px] h-[32px] flex items-center justify-center'>
                    <span className='relative z-[10] uppercase text-[12px] font-bold'>авто игра</span>
