...
export const Settings:FC<SettingsProps> = () => {
    ...
    <div className={`w-full h-full flex justify-center absolute top-0 left-0 bg-[rgba(0,_0,_0,_0.6)] transition-all duration-300 z-[22] ${visibility ? 'opacity-1 visible' : 'opacity-0 invisible'}`}>
        <div className='w-full text-center min-h-[710px] max-w-[1115px] flex flex-col justify-between max-h-[710px] relative h-[calc(100%_-_40px)] p-[40px_20px] m-[20px] bg-[#050505F5]'>
          <X onClick={() => setVisibility(false)} className='absolute top-[30px] right-[30px] text-[#363636] cursor-pointer' />
          <h1 
            className='text-[29px] font-bold uppercase settings-text'
          >
            настройки системы
            </h1>
            <div className='h-full flex flex-col items-center justify-center'>
                <div className='w-full max-w-[850px] flex items-center justify-between'>
                    <div>
                        <div>
                            <h3 className='uppercase text-[20px] font-bold mb-[10px]'>общая ставка</h3>
                        </div>
