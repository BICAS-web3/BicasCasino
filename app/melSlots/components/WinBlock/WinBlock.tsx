...
export const WinBlock:FC<WinBlockProps> = () => {
    ...
    return (
        <div className={`w-full h-full flex justify-center items-center absolute top-0 left-0 bg-[rgba(0,_0,_0,_0.6)] transition-all duration-300 z-[22]`}>
            <div className="w-full max-w-[1110px] h-[350px] sm:h-[450px] m-[20px] relative flex flex-col items-center justify-center text-center">
                <img src={winBlock.src} className='absolute top-0 left-0 w-full h-full' />
                <div className='relative z-[10] flex flex-col items-center'>
                    <h2 className="text-[30px] sm:text-[50px] tbs:text-[70px] leading-[40px] sm:leading-[90px] font-bold uppercase mb-[10px]">поздравляем!</h2>
                    <span className="text-[20px] sm:text-[28px] font-bold mb-[15px] uppercase">вы выиграли</span>
                    <div className='max-w-[200px] sm:max-w-[270px] mb-[20px] w-full h-[70px]  flex items-center justify-center relative'>
                        <img src={winBorder.src} className='absolute w-full h-full left-0 top-0' />
                        <p className='win-text text-[40px] font-black'>15</p>
                    </div>
                    <span className='text-[20px] sm:text-[28px] font-bold uppercase'>бесплатных вращений</span>
