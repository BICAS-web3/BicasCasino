...
export const Rules:FC<RulesProps> = () => {
    return (
        <div className='h-full flex flex-col items-center justify-center'>
            <h2 className="text-[26px] font-bold uppercase mb-[14px]">правила игры</h2>
            <p className="text-[16px] max-w-[812px] text-center font-semibold block mb-[8px]">
            ...
            <p className="text-[16px] max-w-[812px] text-center font-semibold block mt-[30px]">
                Теоретический возврат игроку у этой игры 96.50%
            </p>
            <div className='mt-[30px] flex flex-col gap-[0px]'>
                <span className="text-[16px] uppercase font-bold">минимальная ставка: $0.20</span>
                <span className="text-[16px] uppercase font-bold">максимальная ставка: $50</span>
            </div>
        </div>
    )
}