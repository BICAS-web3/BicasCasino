...
export const Htp:FC<HtpProps> = () => {
    return (
        <div className='flex flex-col'>
            <h2 className="text-[26px] text-center font-bold uppercase mb-[14px]">как играть</h2>
            <div className='text-center flex flex-col items-center'>
                <p className="text-[16px] font-bold flex items-center gap-[10px]">
                ...
                <p className="text-[16px] font-bold block mt-[8px]">
                    Выберите ставку, которую вы хотите использовать в игре.
                </p>
            </div>
            <div className='text-center flex flex-col items-center mt-[40px]'>
                <h2 className="text-[26px] text-center font-bold leading-[35px] uppercase mb-[8px]">ГЛАВНЫЙ ИНТЕРФЕЙС ИГРЫ</h2>
                <p className="text-[16px] font-bold flex items-center gap-[10px]">
            ...
            <p className='text-[16px] font-bold block mb-[8px] mt-[40px] text-center'>
            ...
            <div className='text-[16px] justify-center m-[30px_auto_0_auto] font-bold text-center max-w-[690px] flex items-center gap-[10px]'>
                <div className='min-w-[40px] cursor-pointer h-[40px] relative inline-flex items-center justify-center'>
                    <Plus />
                    <Border className='w-full h-full absolute top-0 left-0' />
                </div>
                и
