...
export const SettMenu:FC<SettMenuProps> = () => {
    return (
        <div className='flex flex-col items-center'>
            <h2 className="text-[12px] sm:text-[26px] text-center font-bold uppercase mb-[14px]">меню настроек</h2>
            <p className="text-[10px] sm:text-[16px] text-center font-bold block mb-[8px]">
            ...
            <h2 className="text-[12px] sm:text-[26px] text-center font-bold uppercase mt-[30px] mb-[14px] tracking-[4%]">ИНФОРМАЦИОННЫЙ ЭКРАН</h2>
            <p className="text-[10px] sm:text-[16px] font-bold flex items-center gap-[10px] mb-[8px]">
                <Prev className='w-[32px] h-[32px]' />
                и
                <Next className='w-[32px] h-[32px]' /> Перелистывают информационные страницы.
            </p>
            <p className="text-[10px] sm:text-[16px] font-bold text-center flex items-center gap-[10px] mb-[8px]">
                <Close className='w-[32px] h-[32px]' />
                Закрывает информационны экран.
            </p>
            <h2 className="text-[12px] sm:text-[26px] text-center font-bold uppercase mt-[30px] mb-[14px]">меню ставок</h2>
            ...
            <p className="text-[10px] sm:text-[16px] font-bold text-center flex items-center gap-[10px] mb-[8px]">
                ...
                <div className='w-[40px] cursor-pointer h-[40px] relative inline-flex items-center justify-center'>
                    <Plus className='w-[15px] sm:w-[30px] sm:h-[30px]' />
                    <Border className='w-full h-full absolute top-0 left-0' />
                </div>
                и
                <div className='w-[40px] cursor-pointer  h-[40px] relative inline-flex items-center justify-center'>
                    <Minus className='w-[15px] sm:w-[30px] sm:h-[30px]'  />
                    <Border className='w-full h-full absolute top-0 left-0' />
                </div>
