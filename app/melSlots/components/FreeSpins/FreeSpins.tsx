...
export const FreeSpins:FC<FreeSpinsProps> = () => {
    return (
        <div className='h-full flex flex-col items-center justify-center'>
            <h2 className="text-[26px] font-bold uppercase mb-[14px]">правила бесплатных спинов</h2>
            <p className="text-[16px] max-w-[850px] text-center font-semibold block mb-[14px]">
                Функция “Бесплатных спинов” присуждается, когда 4 или более символов MELLSPIN выпадают в любом месте экрана.
            </p>
            <p className="text-[16px] max-w-[850px] text-center font-semibold mb-[14px]">
