...
export const $showTransaction = createStore<boolean>(false)

export const setShowTransaction = createEvent<boolean>()
...
$showTransaction.on(setShowTransaction, (_, state) => state)
