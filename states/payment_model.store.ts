...
export const $withdrewCrypto = createStore<boolean>(false)
export const $withdrewFiat = createStore<boolean>(false)
export const $buyCrypto = createStore<boolean>(false)
export const $buyFiat = createStore<boolean>(false)
...
export const setWithdrewCrypto = createEvent<boolean>()
export const setWithdrewFiat = createEvent<boolean>()
export const setBuyCrypto = createEvent<boolean>()
export const setBuyFiat = createEvent<boolean>()
...
$withdrewCrypto.on(setWithdrewCrypto, (_, state) => state)
$withdrewFiat.on(setWithdrewFiat, (_, state) => state)
$buyCrypto.on(setBuyCrypto, (_, state) => state)
$buyFiat.on(setBuyFiat, (_, state) => state)
