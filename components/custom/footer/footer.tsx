...
const Footer = () => (
  <div className='bg-[#181818] rounded-none sm:rounded-[12px_12px_0_0] mb-[40px] sm:mb-0 flex flex-col justify-center items-center w-full p-5 sm:p-[2.5rem_2.5rem_10px_2.5rem] gap-y-3'>
