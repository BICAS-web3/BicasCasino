...
export const BalanceHover:FC<BalanceHoverProps> = ({balance}) => {
    ...
    return (
        <div className={`balance-hover absolute w-[265px] sm:w-[330px] overflow-hidden left-[auto] sm:right-[auto] right-[-30px] xxxs:right-0 sm:left-[50%] sm:translate-x-[-50%] top-[calc(100%_+_20px)] z-[99999] bg-[#181818] rounded-[20px] transition-all duration-200 border border-[#212121] p-[14px_20px]`}>
            <div
            ...
            <div className='flex flex-col items-center justify-center gap-[5px] mb-[10px] pb-[10px] border-b-[1px] border-[#2e2e2e]'>
                <span className="text-[13px] font-semibold text-[#fff] leading-[17px]">Your Bonus Coins Balance</span>
            ...
            <div className='flex flex-col items-center justify-center gap-[5px] mb-[10px] pb-[10px] border-b-[1px] border-[#2e2e2e]'>
                <span className="text-[13px] font-semibold text-[#fff] leading-[17px]">Your Drax Coins Balance</span>
                <div className='flex gap-[5px] items-center'>
            ...
            <div className='flex flex-col items-center justify-center gap-[5px] mb-[10px] pb-[10px] border-b-[1px] border-[#2e2e2e]'>
                <span className="text-[13px] font-semibold text-[#fff] leading-[17px]">Your Redeemable Balance</span>
                <div className='flex gap-[5px] items-center'>
                    <DraxMiniSVG className='w-[20px] aspect-square object-contain' />
                    <span className='text-[14px] leading-[19px] flex gap-[5px] items-end'>
                        <span className='uppercase text-[12px] leading-[18px]'>bc</span>
            ...
            <p className="text-[#979797] text-[12px] font-normal text-center">
                All Drax coins must be played at least once to become redeemable. For every DC 10 redeemed, you will receive 10$
            </p>
        </div>
    )
}