...
const Header = () => {
  ...
  return (
    <header className={`flex justify-between items-centers h-[60px] ${!opened ? "px-3 sm:!pr-10" : "px-3"} sm:px-5 py-3 box-border sticky max-h-14 sm:max-h-16 top-0 z-[50] w-full bg-black`}>
      <Logo />
