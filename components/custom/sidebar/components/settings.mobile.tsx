...
import { BurgerMenuSVG, ChatSVG, UserSVG } from './icons/mobile'
  ...
  return (
    ...
    >
      <div
        ...
        className='w-[40px] bottom-svg flex items-center justify-center h-[40px]'
      >
        <BurgerMenuSVG className='object-contain text-[#7E7E7E]' />
      </div>
      <div
        data-games={true}
        className='w-[40px] h-[40px] bottom-svg flex items-center justify-center'
        onClick={handleGamesOpen}
      >
