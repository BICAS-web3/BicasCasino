    ...
    <>
      {isMobile ? (
        <div
          id='sidebar'
          className={cn(
            `bg-[#181818]  sm:sticky z-[55] sm:z-50 left-0 sm:top-[59px] flex flex-col w-full border-r-[1px] border-[#252525]`,
            open
              ? 'sm:w-[257px] h-[calc(100vh_-_56px)] sm:h-[calc(100vh_-_60px)] top-[56px]'
              : 'sm:w-[90px] h-max sm:h-[calc(100vh_-_60px)] bottom-0',
