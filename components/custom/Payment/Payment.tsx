    ...
    <>
      ...
      <div
        className={`
          ...
          duration-700 transition-all opacity-0 invisible
          ${paymentVisibility && 'opacity-100 visible'}
        `}
      >
      ...
      duration-500 transition-all pb-0 scale-0
      ${storeType === 'buy' && ' pb-[95px] h-full '}
      ${storeType === 'redeem' && '!h-full pb-[80px]'}
      ${storeType === 'tips' && '!h-full pb-[80px] sm:pb-0 sm:h-auto '}
      ${paymentVisibility && 'scale-1'}
    `}
          >
            <div
