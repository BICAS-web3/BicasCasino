...
export const MinesSettings = () => {
  ...
  return (
    <div
      ...
      } col-start-1 col-end-3 m-[0_auto] w-full max-w-[330px] tbs:absolute tbs:top-[calc(-100%_-_10px)] tbs:right-[250px] bg-[#151515]  rounded-[20px] border-[#3e3e3e] p-6 box-border`}
    >
