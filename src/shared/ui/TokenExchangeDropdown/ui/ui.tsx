...
import { ArrowIcon } from '@/src/shared/SVGs'
import { useDropdown } from '@/lib/utils'
  ...
  return (
    ...
    >
      ...
      >
        {selectedToken ? (
          <div
          // className={styles.token_item_selected}
          >
            <Image
      ...
      <div
      // className={clsx(styles.token_list, { [styles.open]: isOpen })}
      >
        {tokenList.map(token => (
          <div
            key={token.id}
