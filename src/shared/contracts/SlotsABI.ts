export const ABI = [
  {
    inputs: [
      ...
      { internalType: "uint16[]", name: "_multipliers", type: "uint16[]" },
      { internalType: "uint16[]", name: "_outcomeNum", type: "uint16[]" },
      { internalType: "uint16", name: "_numOutcomes", type: "uint16" },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct Slots.SlotsGame",
        name: "",
        type: "tuple",
      },
    ],
