export const ABI = [
  ...
  { inputs: [], name: "MultiplierAlreadySet", type: "error" },
  ...
  },
  {
    ...
    name: "Apples_Refund_Event",
    type: "event",
  },
  {
    inputs: [{ internalType: "address", name: "player", type: "address" }],
    name: "Apples_GetState",
    outputs: [
      {
        components: [
          { internalType: "uint256", name: "wager", type: "uint256" },
          ...
          { internalType: "uint8[]", name: "pickedTiles", type: "uint8[]" },
        ],
        internalType: "struct Apples.ApplesGame",
        name: "",
        type: "tuple",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "uint16[9]", name: "multipliers", type: "uint16[9]" },
    ],
    name: "setApplesMultipliers",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
