...
const UpperControlls: FC<UpperControllsProps> = props => {
    ...
    return (<div className={s.upper_controlls}>
...
const BottomControlls: FC<BottomControllsProps> = props => {
    ...
    return (<div className={s.bottom_controlls}>
        <input className={s.over_input} min={5} max={99.9} type="string" onChange={onChange} value={rollString}></input>
