            ...
            <div className={s.footer_container}>
                <div className={s.footer_body}>
                    ...
                    <div className={s.games_list}>
                        <Link href="" className={s.footer_text}>GAMES</Link>
                        <Link href="" className={s.game_row}>Coinflip</Link>
                        <Link href="" className={s.game_row}>Dice</Link>
                        <Link href="" className={s.game_row}>Rock paper scissors</Link>
                        <Link href="" className={s.game_row}>Poker</Link>
                    </div>

                    <div className={s.footer_mainPages_list}>
                        <Link href="" className={s.footer_text}>support</Link>
                        <Link href="" className={s.footer_text}>Profile</Link>
                        <Link href="" className={s.footer_text}>NFT Market</Link>
                        <Link href="" className={s.footer_text}>Leader board</Link>
                    </div>
