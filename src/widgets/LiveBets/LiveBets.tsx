    ...
    <div className={s.liveBets_list_item}>
      <div className={s.liveBets_list_item_time_block}>
        <a
          href={props.trx_url}
          target="_blank"
          className={s.liveBets_list_item_time_link_block}
        >
      ...
      <div className={s.liveBets_list_item_game_block}>
        <a
          href={props.game_url}
          target="_blank"
          className={s.liveBets_list_item_game_link_block}
        >
          <Image
            src={gameIco}
            className={s.liveBets_list_item_game_ico}
      ...
      <div className={s.liveBets_list_item_player_block}>
        <a
          ...
          target="_blank"
          className={s.liveBets_list_item_player_link_block}
        >
          <div
            className={s.liveBets_list_item_player_ico}
            style={{ background: props.userBg }}
          >
      ...
      <div className={s.liveBets_list_item_address_block}>
        <span className={s.liveBets_list_item_address}>
          {props.gameAddress}
        </span>
      </div>
    ...
    <div className={s.liveBets_wrap}>
      ...
      <div className={s.liveBets_body}>
        <div className={s.liveBets_titles_list}>
          ...
          <span className={s.liveBets_titles_list_item} data-id="address">
            Address
          </span>
          <span className={s.liveBets_titles_list_item} data-id="wager">
            Wager
          </span>
          <span className={s.liveBets_titles_list_item} data-id="multiplier">
            Multiplier
          </span>
          <span className={s.liveBets_titles_list_item} data-id="profit">
            Profit
          </span>
          <span className={s.liveBets_titles_list_item} data-id="explorer">
            Explorer
          </span>
        </div>
