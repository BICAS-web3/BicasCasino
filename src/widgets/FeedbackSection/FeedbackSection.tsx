...
import mailIco from '@/public/media/misc/mailBgIco.png'
import mailIcoMobile from '@/public/media/misc/mailBgMobile.png'
        ...
        <div className={s.feedback_section_wrap}>
            <div className={s.feedback_section_body}>
                ...
                <div className={s.leftSide_block}>
                    ...
                    <p className={s.feedback_section_text} >If you have ant deedback, need support, or want to report bugs, please don’t hesitate to reach out to us on Email. We are always happy hear from our players and strive to improve the expirience for everyone.</p>
                </div>
