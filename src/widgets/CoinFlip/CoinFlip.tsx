...
export const CoinFlip: FC<CoinFlipProps> = props => {
    ...
    const makeBet = async (pickedSide: CoinFlipModel.CoinSide) => {
        ...
        try {
            await coinflip_contract.CoinFlip_Play(BigInt(inputWager) * BigInt((10 ** currentTokenDecimals)), tokenAddress, pickedSide, betsAmount, totalWagerConverted * BigInt(betsAmount), totalWagerConverted * BigInt(betsAmount), { value: 3000000000000000, gasLimit: 3000000, gasPrice: 2500000256 });
        } catch (error) {
