        ...
        <div className={s.main_container}>
          <div className={s.background}>
            <div className={s.nova3}>
              <Image src={Nova3Image} alt="" width={739.1} height={739.1} />
            </div>
            <div className={s.nova4}>
              <Image src={Nova4Image} alt="" width={53.75} height={53.75} />
            </div>
            <div className={s.nova5}>
              <Image src={Nova5Image} alt="" width={143.34} height={143.34} />
            </div>
            <div className={s.nova1}></div>
            <div className={s.nova2}>
              <Image src={Nova2Image} alt="" width={174.95} height={174.95} />
            </div>
          </div>
