...
import BlurModal from '@/widgets/Blur/model'
import {useUnit} from "effector-react";
import * as MainWallet from "@/pages/model";
import * as BlurModel from "@/widgets/Blur/model";


export const GamePage = ({children, gameTitle, gameInfo = {}}) => {
    ...
    return (
        <div className={s.game_layout}>
            <div className={s.game_wrap}>
                <GamePageModal text={gameInfo.text} closeModal={closeModal} modalVisible={modalVisibility} />
                ...
                <div className={s.game_body}>
                    <div className={s.game_header}>
                        ...
                        <button className={s.game_info_btn} onClick={handleModalVisibilityChange}>About the game</button>
                    </div>
