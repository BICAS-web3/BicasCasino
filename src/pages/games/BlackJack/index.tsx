...
const BlackJack: FC<BlackJackProps> = () => {
  ...
  return (
    <>
      <Head>
        <title>Games - Black Jack</title>
      </Head>
      <Layout activePageLink="/games/BlackJack" gameName="Bj">
        <LiveBetsWS subscription_type={"Subscribe"} subscriptions={["Bj"]} />
        <div className={s.bj_container}>
          <GamePage
            isPoker={false}
            gameInfoText=""
            gameTitle="bj"
