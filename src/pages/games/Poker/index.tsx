...
const WagerContent = () => {
  ...
  return (
    <>
      <WagerInputsBlock />
      <button className={s.poker_wager_drawing_cards_btn} onClick={pressButton}>Drawing cards</button>
    ...
    <Layout gameName="Poker">
      ...
      <div className={s.poker_container}>
        ...
        >
          ...
          {showFlipCards && <div className={s.poker_flip_cards_info_wrapper}>
            <PokerFlipCardsInfo onCLick={() => { flipShowFlipCards() }} />
          </div>}
